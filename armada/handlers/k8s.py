...
CONF = cfg.CONF
DEFAULT_TIMEOUT = 300  # TODO(MarshM) get sensible timeouts
...
class K8s(object):
    ...
    def wait_get_completed_podphase(self, release, timeout=DEFAULT_TIMEOUT):
        '''
    ...
    def wait_until_ready(self,
        ...
        if not label_selector:
            LOG.warn('Labels not specified, waiting with no labels may cause '
