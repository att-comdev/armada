...
class Manifest(object):
    ...
    def __init__(self, documents, desired_manifest=None):
        ...
        * A document with schema "armada/Manifest/v*"

        If multiple documents with schema "armada/Manifest/v1" are provided,
        use ``desired_manifest`` to select the desired one to use.

        :param List[dict] documents: Documents out of which to build the
            Armada Manifest.
        :param str desired_manifest: The desired manifest to use when multiple
