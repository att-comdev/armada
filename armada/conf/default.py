...
default_options = [
    ...
    cfg.StrOpt(
        ...
        default='%(asctime)s.%(msecs)03d %(process)d ERROR '
        ' %(name)s %(instance)s',
    ...
    cfg.StrOpt(
        ...
        help='Defines the format string for %(user_identity)s that is '
        'used in logging_context_format_string.'
    ),
    cfg.BoolOpt(
        'middleware',
        default='false',
    ...
    cfg.StrOpt(
        ...
        default='CRITICAL',
        help='Log level name used by rate limiting: CRITICAL,'
    ...
    cfg.BoolOpt(
        'watch_log_file',
        default='false',
        help='Enables instantaneous recreation of a logging file '
