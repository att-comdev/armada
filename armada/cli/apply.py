...
@click.option('--enable-chart-cleanup',
              ...
              is_flag=True)
@click.option('--set',
              help=("Use to override single Armada Manifest values. Accepts "
...
@click.option('--values',
              '-f',
              ("Use to override multiple Armada Manifest values by reading "
               "overrides from a values.yaml-type file."),
              multiple=True,
              type=str,
              default=[])
@click.option('--wait',
