...
class TillerTestCase(base.ArmadaTestCase):
    ...
    def test_get_tiller_namespace(self, mock_grpc, _, mock_ip):
        ...
        # verifies namespace set via instantiation
        tiller_obj2 = tiller.Tiller(None, '8080', 'test_namespace2')
        self.assertEqual('test_namespace2',
                         tiller_obj2._get_tiller_namespace())
        # verifies namespace set via instantiation
        tiller_obj3 = tiller.Tiller('host', '8080', 'test_namespace2')
        self.assertEqual('test_namespace2',
                         tiller_obj3._get_tiller_namespace())
    ...
    def test_get_tiller_status(self, mock_grpc, _, mock_ip):
        ...
        tiller_obj = tiller.Tiller(None, None, 'namespace')
        not self.assertTrue(tiller_obj.tiller_status())
