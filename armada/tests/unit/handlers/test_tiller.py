...
class TillerTestCase(unittest.TestCase):
    ...
    @mock.patch('armada.handlers.tiller.InstallReleaseRequest')
    @mock.patch('armada.handlers.tiller.ReleaseServiceStub')
    def test_get_tiller_port(self, mock_stub,
                             mock_install_request,
                             mock_config, mock_grpc, mock_k8s,
                             mock_ip):
        # instantiate Tiller object
        tiller = Tiller(None, '8080', None)
        self.assertEqual(tiller._get_tiller_port(), '8080')
    ...
    @mock.patch('armada.handlers.tiller.InstallReleaseRequest')
    @mock.patch('armada.handlers.tiller.ReleaseServiceStub')
    def test_get_tiller_namespace(self, mock_stub,
                                  mock_install_request,
                                  mock_config, mock_grpc, mock_k8s,
                                  mock_ip):
        # instantiate Tiller object
        tiller = Tiller(None, None, 'test_namespace')
        self.assertEqual(tiller._get_tiller_namespace(), 'test_namespace')
    ...
    @mock.patch('armada.handlers.tiller.InstallReleaseRequest')
    @mock.patch('armada.handlers.tiller.ReleaseServiceStub')
    def test_get_tiller_status(self, mock_stub,
                               mock_install_request,
                               mock_config, mock_grpc, mock_k8s,
                               mock_ip):
        # instantiate Tiller object
        tiller = Tiller(None, '8080', None)
        self.assertEqual(tiller.tiller_status(), True)
