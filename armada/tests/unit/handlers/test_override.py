...
class OverrideTestCase(unittest.TestCase):
    ...
    def test_chart_override(self):
        ...
        overridden_cfg = Override(config=config,
                                  overrides=override).get_manifest()
    ...
    def test_value_override(self):
        '''
        Test overriding values with a dict
        '''
        ...
        overridden_cfg = Override(config=config, values=values).get_manifest()
    ...
    def test_invalid_override_type(self):
        ...
        with self.assertRaises(ovr_exceptions.InvalidOverrideTypeException):
            Override(config=config, overrides=override).get_manifest()
