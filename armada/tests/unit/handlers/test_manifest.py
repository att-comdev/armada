...
class ManifestTestCase(testtools.TestCase):
    ...
    def test_verify_build_chart_group_deps(self):
        ...
        openstack_keystone_chart_group_deps = armada_manifest. \
            build_chart_group(chart_group)
        keystone_infra_services_dep_added = openstack_keystone_chart_group_deps[
            'data']['chart_group'][0]['chart']['dependencies']
        ...
        self.assertEqual(keystone_infra_services_dep_added[0], mariadb_dependencies[0])
        self.assertEqual(keystone_infra_services_dep_added[0], memcached_dependencies[0])
