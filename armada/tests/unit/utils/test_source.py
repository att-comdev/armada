...
class GitTestCase(base.ArmadaTestCase):
    ...
    def test_git_clone_good_url_with_ssh(self):
        self.override_config('ssh_key_path', '/opt/stack/ucp/foobar', None)
        url = 'ssh://fm577c@gerrit.mtn5.cci.att.com:29418/mos-tempest'
        git_dir = source.git_clone(url, ref='3.0.3', auth_method='SSH')
        self._validate_git_clone(git_dir)
